...
class AgentRunner:
    ...
    def _generate_activities(self) -> List:
        ...
        # Always include the generic activities that workflows expect
        activities.extend([_agent_task_activity, _agent_streaming_activity])
        logger.info(f"📌 Added generic activities: _agent_task_activity, _agent_streaming_activity")
        
        # Discover @agent_activity decorated methods (these will be called by the generic activities)
